 ...
 * @author pes2704
 */
class TesterContainerConfiguratorMUJ extends ContainerConfiguratorAbstract {
...
//
            'nameAdresarLogs' => 'Logs/Testik',
            'nameFileSessionLog' => 'TestikSession.log',
            'nameFileTesterApplicationLog' => 'TestikTesterApplication.log',
//            'nameSession' => 'TesterSession',
            'nameRouterLog' => 'TestikRouter.log',
//
//            // request
...
//                                        
           ...
           // database
            Handler::class => function(ContainerInterface $c) : HandlerInterface {
                $connectionInfoUtf8 = new ConnectionInfo( DbTypeEnum::MySQL, $c->get('databaseHost'), $c->get('databaseName'));
