    ...
    <link rel="stylesheet" type="text/css" href="<?= Middleware\Web\AppContext::getAppPublicDirectory().'grafia/css/zkouska_less.css'?>" />
    ...
    <script src="<?= Middleware\Web\AppContext::getAppPublicDirectory().'grafia/js/hamburger.js'?>"></script>
    <script src="<?= Middleware\Web\AppContext::getAppPublicDirectory().'grafia/js/kalendar.js' ?>" defer></script>
