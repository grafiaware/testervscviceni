...
// <img width="234" height="167" alt="soubor plat.gif" src="files/1096212.gif" style="color: #ffffff; float: right;">
    ...
    private function transformUrls($text) {
        ...
        /** @var PresentationStatusModel $presentationStatusModel */
        $presentationStatusModel = $this->container->get(PresentationStatusModel::class);
        $langCode = $presentationStatusModel->getPresentationStatus()->getLanguageCode();
        $transform = [];
        $end = 0;
