...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= $basePth ?>public/css/zaverFormular.css">                            
    </head>
    <body>
        <br><br>
        ...
        <button  type="submit" formmethod="get" 
                 formaction= "<?= $basePth ?>vysledky/"> Chcete něco vidět???? </button> 
                <button  type="" formmethod="get" 
                 formaction= "<?= $basePth ?>uloha/<?= $prvniKlic ?>/"> ...prohlidka vyplneneho testu..</button>     <!--  na cislo, ktere existuje -->
        <br/>   <br/>    <br/>         
