 ...
 * @author vlse2610
 */
class Ulohy implements DaoInterface  {
    
    private $cesta;

    /**
     * 
     * @param string $cestaKSadamOtazekASpravnychOdpovedi Cesta k složce se sadami otázek
     */
     ...
     * Vrací entitu Uloha
     * 
     * @param scalar $id Identifikátor úlohy v souboru sady úloh
     * @param string $nazevSady Název sady
     * @return Uloha
     */    
