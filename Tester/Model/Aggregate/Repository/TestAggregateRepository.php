 ...
 * 
 */
class   TestAggregateRepository   implements TestAggregateRepositoryInterface{
    ...
    /**
     * 
     * @param PrubehTestu $repoPrubehTestu
     * @param \Tester\Model\Session\Repository\SessionTestu $repoSessionTestu
     * @param Odpoved $repoOdpoved
     * @param OdpovedNaOtazku $repoOdpovedNaOtazku
     * 
     * @param \Tester\Model\Aggregate\Hydrator\AggregateHydrator $hydrator
     */
    public function __construct(      PrubehTestu  $repoPrubehTestu,  
