...
// Bohužel PHP neumožňuje vyhazovat výjimky uvnitř metody __toString(), proto je nutné ještě handler vypnout v metodách ->toString()
...
$packageAutoloader = new Autoloader_Autoloader(NULL, '..'); //autoload pro všechny package ve složkách na stejné úrovni
$packageAutoloader->register();
