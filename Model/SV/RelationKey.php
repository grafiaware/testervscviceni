...
namespace Aggregate\Models\Relation;
...
//        $this->idMD5 = md5($this->id);
    ...
    public function setKeyHash(array $keyHash) {
        if ($this->isGeneratedKey) {
            throw new \LogicException('Klíč je generovaný a hodnoty genrovaného klíče lze nastavit pouze hydrátorem při čtení z databáze.');
        }
