...
$pesAutoloader->addNamespace('TestovaciKlikator', '');
$pesAutoloader->addNamespace('Framework', '../Framework');
$pesAutoloader->addNamespace('Pes', '../Pes/src');
$pesAutoloader->addNamespace('Psr\Log', '../vendor/Psr/Log/Psr/Log');
$pesAutoloader->addNamespace('Zakazky', '../Zakazky');
$pesAutoloader->addNamespace('Accessor', '../Accessor');
...
function logExceptionHandler($e) {
    $development= $GLOBALS['development'] ? TRUE : FALSE;
...
function logErrorHandler($errno, $errstr, $errfile, $errline) {
    ...
    //        break;
        ...
        case E_USER_NOTICE:
            ...
            break;
        default:
            $errorLogger->debug("PHP error or unknown user error type: [$errno] [$time] $errstr on line $errline in file $errfile");
            break;
    }    
    if ($development) {
